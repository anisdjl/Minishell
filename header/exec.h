...
void						exec_pipe_subshell2(t_tree *node, t_env *env,
...
int							create_file(t_tree *node, t_env *env,
								t_redir *redir);
...
void						close_extra_fds(t_tree *node, int fd_in,
								int fd_out);
int							exec_pipe_subshell(t_tree *node, t_env *env,
								int fd_in, int fd_out);
...
int							write_in_file_lp1(char *line, t_redir *redir,
								t_env *env);
int							write_in_file_check(char *line, t_redir *redir,
								t_env *env);
int							write_in_file(t_tree *node, t_env *env,
								t_redir *redir);
